...
class AMRBartTokenizer(BartTokenizer):
    ...
    def init_amr_vocabulary(self):
        ...
        self.amr_dfs_NLR_token = "<dfs_NLR>"
        self.amr_dfs_NLR_token_id = self.encoder[self.amr_dfs_NLR_token]
        self.amr_dfs_NRL_token = "<dfs_NRL>"
        self.amr_dfs_NRL_token_id = self.encoder[self.amr_dfs_NRL_token]

        # add special token
        special_tokens = {'additional_special_tokens': \
            [self.amr_dfs_NLR_token, self.amr_dfs_NRL_token]}
