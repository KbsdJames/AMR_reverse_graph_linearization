...
DataPath=/mlx_devbox/users/gbf/playground/AMR-Process_gp2022/outputs_debug2/$Dataset

ModelCate=AMRBART-large

MODEL=/mlx_devbox/users/gbf/playground/mixed_decoder_KD_loss_exponential_decay/fine-tune/outputs/LDC2017-AMRBART-large-AMRParing-bsz128-lr-2e-5-UnifiedInp-gate-add-model_gen_sample0.3_exponential_scheduled_v2/checkpoint-13110
ModelCache=$BasePath/.cache
DataCache=$DataPath/.cache/dump-amrparsing

lr=2e-5

OutputDir=${RootDir}/outputs/Eval-LDC2017-AMRBART-large-AMRParing-bsz64-lr-2e-5-UnifiedInp-gate-add-model_gen_sample0.3_exponential_scheduled_v2_swap_gt
